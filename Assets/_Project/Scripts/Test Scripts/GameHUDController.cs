...
namespace _Project.Scripts.Test_Scripts
{
    ...
    public class GameHUDController : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            ...
            {
                Debug.LogError($"<color=yellow>No UIDocument found!");
                return;
            }
            ...
            AddDropdownItemToBuild("Edit Harbour",       OnEditHarbourClicked);
            AddDropdownItemToBuild("Save and Exit",      OnSaveAndExitClicked);
            AddDropdownItemToBuild("Exit Without Saving", OnExitWithoutSavingClicked);
        ...
        private void OnExitWithoutSavingClicked()
        {
            //Debug.Log("Exit Without Saving clicked");
            // ← Add your real logic here later
        }
    }
}
