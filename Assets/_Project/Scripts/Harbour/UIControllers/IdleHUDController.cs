...
namespace _Project.Scripts.Harbour.UIControllers
{
    public class IdleHUDController : MonoBehaviour
    {
        ...
        private void Awake()
        {
            if (uiDocument == null)
            {
                Debug.LogError("UIDocument not assigned on IdleHUDController!", this);
                return;
            }
        ...
        private void CreateTopBar()
        {
            ...
            // Full-width top bar (same style as the others)
            var topBar = new VisualElement { name = "IdleTopBar" };
            ...
            topBar.style.backgroundColor = new StyleColor(new Color(0.07f, 0.13f, 0.28f, 0.95f));
            ...
            root.Add(topBar);
            root.Add(dropdownPanel);

            Debug.Log("Idle HUD top bar ready");
        }
        ...
        private void ToggleDropdown()
        {
            ...
            Debug.Log($"Idle HUD dropdown {(isDropdownOpen ? "OPENED" : "CLOSED")}");
        }
